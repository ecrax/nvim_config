...
return {
	...
	-- special sections
	s(
		{ trig = "#l", name = "lecture", dscr = "fancy section header - lecture #" },
		fmt(
			[[ 
    \lecture[<>]{<>}
    <>]],
	...
	s(
		{ trig = "#ch", name = "chap", dscr = "fancy section header - chapter #" },
		fmt(
			[[ 
    \bookchap[<>]{<>}{<>}
    <>]],
	...
	s(
		{ trig = "#f", name = "fancy section", dscr = "fancy section header - vanilla" },
		fmt(
			[[ 
    \fancysec[<>}{<>}{<>}
    <>]],
	...
	-- code
	s(
		{ trig = "qw", name = "inline code", dscr = "inline code" },
		fmt([[\mintinline{<>}{<>}<>]], { i(1, "text"), i(2), i(0) }, { delimiters = "<>" })
	),
	s(
	...
	s("tikztest", { t("this works only in tikz") }, { condition = tikz, show_condition = tikz }),
},
	{
		-- bullet points
		s({ trig = "-", hidden = true }, { t("\\item") }, { condition = (bp and line_begin), show_condition = bp }),
		-- math mode
    ...
    <>]],
		...
		s(
			{ trig = "mgat", name = "gather", dscr = "gather math" },
			fmt(
				[[ 
    \begin{gather<>}
    <>
    ...
    \text{<>}<>
		...
		-- operators, symbols
		s({ trig = "**", priority = 100 }, { t("\\cdot") }, { condition = math }),
		...
		s(">>", { t("\\gg") }, { condition = math }),
		s("<<", { t("\\ll") }, { condition = math }),
		s("~~", { t("\\sim") }, { condition = math }),
		-- sub super scripts
		s(
		...
		s(
			{ trig = "__", name = "subscript iii", dscr = "auto subscript for brackets" },
			fmt(
				[[ 
    _{<>}<>
    ]],
		...
		s("xnn", { t("x_n") }, { condition = math }),
		s("xii", { t("x_i") }, { condition = math }),
		s("xjj", { t("x_j") }, { condition = math }),
		s("ynn", { t("y_n") }, { condition = math }),
		s("yii", { t("y_i") }, { condition = math }),
		s("yjj", { t("y_j") }, { condition = math }),
		...
		s({ trig = "vtr", wordTrig = false }, { t("^{T}") }, { condition = math }),
		...
		s("cq", { t("\\subseteq") }, { condition = math }),
    ...
    \frac{\partial <>}{\partial <>} <>
		...
		s(
			{ trig = "elr", name = "left right eval", dscr = "evaluated at left/right" },
			fmt(
				[[ 
    \left. <> \right|<>
    ]],
		...
		s("=>", { t("\\implies") }, { condition = math, show_condition = math }),
		s("=<", { t("\\impliedby") }, { condition = math, show_condition = math }),
		s("iff", { t("\\iff") }, { condition = math, show_condition = math }),
		-- utils
		s("||", { t("\\mid") }, { condition = math }),
		s("lb", { t("\\\\") }, { condition = math }),
		s("tcbl", { t("\\tcbline") }, { condition = math }),
		s("ctd", { t("%TODO: "), i(1) }),
		s("->", { t("\\to") }, { condition = math }),
		s("<->", { t("\\leftrightarrow") }, { condition = math }),
		...
		s(
			...
			fmt([[\left\lceil <> \right\rfloor <>]], { i(1), i(0) }, { delimiters = "<>" }),
			{ condition = math }
		),
	}
